...
def morshed1():
        ...
        return ua
#-----------------------------------------------------#
vers = requests.get('https://raw.githubusercontent.com/dx-RAFSAN-king/F-44/main/LXRAFSAN.txt').text
version = str(vers)
#-------------------------------#
...
try:
    os.system('clear')
    xnx = requests.get('https://raw.githubusercontent.com/dx-RAFSAN-king/F-44/main/LXRAFSAN.txt').text
...
def menu():
  ...
  try:
    httpCaht = requests.get('https://github.com/Rafsan-402/Rafsan/blob/main/Approve.txt').text    
    if id in httpCaht:
